...
namespace Steamp3
{
    ...
    public static class Global
    {
        ...
        public static void GenerateConfigXml(string url)
        {
            try
            {
                XmlDocument xml = new XmlDocument();
        ...
        public static string GoogleSearch(string text)
        {
            ...
            try
            {
                ...
                {
                    if (s[i] == "unescapedUrl") return "First google result for: {ls}" + text + "{rs}" + Environment.NewLine + s[i + 2];
                }
            ...
            try
            {
                ...
                foreach (XmlNode user in users)
                {
                    if (GetXmlValue(user, "ID", "0") == steamID.ToUInt64().ToString())
                    {
                        ...
                        UI.Achievement achievement = Global.MainWindow.AchievementList.GetItemByID(UI.Achievement.AchievementIDs.ChattyCathy);
                        ...
                        achievement = Global.MainWindow.AchievementList.GetItemByID(UI.Achievement.AchievementIDs.JukeboxHero);
                        ...
                        achievement = Global.MainWindow.AchievementList.GetItemByID(UI.Achievement.AchievementIDs.LeetHaxor);
                        ...
                        achievement = Global.MainWindow.AchievementList.GetItemByID(UI.Achievement.AchievementIDs.MP3Playah);
                        ...
                        achievement = Global.MainWindow.AchievementList.GetItemByID(UI.Achievement.AchievementIDs.Repetition);
        ...
        public static string GetRAM()
        {
            ...
            if (!GlobalMemoryStatus(ref ms)) return "Error: {ls}Unable to retrieve system memory{rs}"; ;

            string result = "Physical memory: {ls}" + ConvertBytes(ms.dwAvailPhys) + " / " + ConvertBytes(ms.dwTotalPhys) + "{rs} " + GetPercent(ms.dwAvailPhys, ms.dwTotalPhys) + "%" + Environment.NewLine;
            result += "Virtual memory: {ls}" + ConvertBytes(ms.dwAvailVirtual) + " / " + ConvertBytes(ms.dwTotalVirtual) + "{rs} " + GetPercent(ms.dwAvailVirtual, ms.dwTotalVirtual) + "%" + Environment.NewLine;
            result += "Page file: {ls}" + ConvertBytes(ms.dwAvailPageFile) + " / " + ConvertBytes(ms.dwTotalPageFile) + "{rs} " + GetPercent(ms.dwAvailPageFile, ms.dwTotalPageFile) + "%";
        ...
        public static string GetUsage()
        {
            ...
            string result = "Memory usage: {ls}" + ConvertBytes(p.WorkingSet64) + " / " + ConvertBytes(ms.dwTotalPhys) + "{rs} " + GetPercent(p.WorkingSet64, ms.dwTotalPhys) + "%";
        ...
        #region GetIniValue
        public static string GetIniValue(string ini, string attribute)
        {
            try
            {
                string result = string.Empty;
    ...
    public class MainWindow : UI.Window
    {
        ...
        public MainWindow() : base()
        {
            ...
            p_TabContainer.AddRange(new UI.Tab[] { new UI.Tab("¯", "Playlist", 66), new UI.Tab("º", "Radio", 58), new UI.Tab("^", "Commands", 86), new UI.Tab("%", "Achievements", 98), new UI.Tab(">", "Skins", 56), new UI.Tab("~", "Plug-ins", 70), new UI.Tab("@", "Settings", 72) });

            p_Playlist = new UI.Playlist(this, p_TabContainer);
            p_Playlist.MouseClick += new MouseEventHandler(p_Playlist_MouseClick);
            ...
            p_RefreshButton = new UI.Button(this, p_TabContainer, "q", string.Empty, "Refresh");
            ...
            p_MusicFolderGroup = new UI.FolderBrowserGroup(this, p_TabContainer, "Music folder:", Global.Settings.MusicFolder, "The directory that contains your music files");
            ...
            p_MusicFilterGroup = new UI.DropDownGroup(this, p_TabContainer, "Music filter:", Global.Settings.MusicFilter, "Types of files that will be added to the playlist", new string[] { ".mp3", ".mp3;.wav", ".mp3;.wma", ".mp3;.wav;.wma", ".mp3;.m4a;.wav;.wma" });
            ...
            p_PlaylistFormatGroup = new UI.DropDownGroup(this, p_TabContainer, "Playlist format:", Global.Settings.PlaylistFormat, "Change the appearance of playlist items", new string[] { "{Artist} - {Title}", "{Artist} - {Album} - {Title}", "{Artist} - {Album} - {Track} - {Title}", "{Title} by {Artist}", "{URL}" });
            ...
            p_MainMenu.AddRange(new UI.MenuItem[] { new UI.MenuItem("¯", "Playlist"), new UI.MenuItem("º", "Radio"), new UI.MenuItem("^", "Commands"), new UI.MenuItem("%", "Achievements"), new UI.MenuItem(">", "Skins"), new UI.MenuItem("~", "Plug-ins"), new UI.MenuItem("@", "Settings"), new UI.MenuItem(string.Empty, "-"), new UI.MenuItem("þ", "Check for Updates..."), new UI.MenuItem("", "Release Notes..."), new UI.MenuItem(string.Empty, "-"), new UI.MenuItem("i", "About STEAMp3..."), new UI.MenuItem(string.Empty, "-"), new UI.MenuItem("r", "Exit") });
            ...
            p_FileSystemWatcher.EnableRaisingEvents = true;
        }
        #endregion
        ...
        {
            p_TabContainer.SelectedIndex = 0;
        ...
        {
            p_Playlist.Visible = p_TabContainer.SelectedIndex == 0;
            p_BackButton.Visible = p_TabContainer.SelectedIndex == 0;
            p_PlayButton.Visible = p_TabContainer.SelectedIndex == 0;
            p_StopButton.Visible = p_TabContainer.SelectedIndex == 0;
            p_NextButton.Visible = p_TabContainer.SelectedIndex == 0;
            p_RandomButton.Visible = p_TabContainer.SelectedIndex == 0;
            p_RecordButton.Visible = p_TabContainer.SelectedIndex == 0;
            p_RefreshButton.Visible = p_TabContainer.SelectedIndex == 0;
            p_VolumeDropDown.Visible = p_TabContainer.SelectedIndex == 0;
            p_PlayModeDropDown.Visible = p_TabContainer.SelectedIndex == 0;
            p_SeekBar.Visible = p_TabContainer.SelectedIndex == 0;

            p_StationList.Visible = p_TabContainer.SelectedIndex == 1;
            p_CommandList.Visible = p_TabContainer.SelectedIndex == 2;
            p_AchievementList.Visible = p_TabContainer.SelectedIndex == 3;
            p_SkinList.Visible = p_TabContainer.SelectedIndex == 4;
            p_PluginList.Visible = p_TabContainer.SelectedIndex == 5;

            p_GeneralSettingsLabel.Visible = p_TabContainer.SelectedIndex == 6;
            p_MusicFolderGroup.Visible = p_TabContainer.SelectedIndex == 6;
            p_MusicFilterGroup.Visible = p_TabContainer.SelectedIndex == 6;
            p_TriggerGroup.Visible = p_TabContainer.SelectedIndex == 6;
            p_GlobalCheckBox.Visible = p_TabContainer.SelectedIndex == 6;
            p_SilentCheckBox.Visible = p_TabContainer.SelectedIndex == 6;

            p_WebSettingsLabel.Visible = p_TabContainer.SelectedIndex == 6;
            p_ImageLocationGroup.Visible = p_TabContainer.SelectedIndex == 6;
            p_ImageQualityGroup.Visible = p_TabContainer.SelectedIndex == 6;

            p_AdvancedSettingsLabel.Visible = p_TabContainer.SelectedIndex == 6;
            p_OutputDeviceGroup.Visible = p_TabContainer.SelectedIndex == 6;
            p_PlaylistFormatGroup.Visible = p_TabContainer.SelectedIndex == 6;
        }
        #endregion

        #region Playlist
        private void p_Playlist_MouseClick(object sender, MouseEventArgs e)
        {
            if (p_Playlist.SelectedItem == null) return;

            if (e.Button == MouseButtons.Left && p_Playlist.Clicks > 1) Global.MediaPlayer.Play(p_Playlist.SelectedIndex, "Playing", true);
        }
        #endregion
        ...
        {
            Global.MediaPlayer.Previous("Previous", true);
        }
        #endregion
        ...
        {
            Global.MediaPlayer.Play(p_Playlist.SelectedIndex, "Playing", true);
        }
        #endregion
        ...
        {
            Global.MediaPlayer.Stop("Stopped", true);
        }
        #endregion
        ...
        {
            Global.MediaPlayer.Next("Next", true);
        }
        #endregion
        ...
        {
            Global.MediaPlayer.Random("Random", true);
        }
        #endregion
        ...
        private void p_MainMenu_ItemClicked(object sender, EventArgs e)
        {
            switch (p_MainMenu.SelectedItem.Text)
            {
                case "Playlist":
                    ...
                    break;
                case "Radio":
                    p_TabContainer.SelectedIndex = 1;
                    Global.SetForegroundWindow(Handle);
                    break;
                case "Commands":
                    p_TabContainer.SelectedIndex = 2;
                    Global.SetForegroundWindow(Handle);
                    break;
                case "Achievements":
                    p_TabContainer.SelectedIndex = 3;
                    Global.SetForegroundWindow(Handle);
                    break;
                case "Skins":
                    p_TabContainer.SelectedIndex = 4;
                    Global.SetForegroundWindow(Handle);
                    break;
                case "Plug-ins":
                    p_TabContainer.SelectedIndex = 5;
                    Global.SetForegroundWindow(Handle);
                    break;
                case "Settings":
                    p_TabContainer.SelectedIndex = 6;
                    Global.SetForegroundWindow(Handle);
                    break;
        ...
        public void CheckForUpdates(bool info)
        {
            ...
            try
            {
                ...
                if (info)
                {
                    UI.InfoDialog id = new UI.InfoDialog("This version of STEAMp3 is up to date, no new updates available.");
                    id.ShowDialog(this);
                    id.Dispose();
                }
            }
        ...
        {
            if (string.IsNullOrEmpty(filter)) filter = ".mp3;.m4a;.wav;.wma";
        ...
        public bool ProcessGlobalCommand(string msg, bool chat)
        {
            ...
            else
            {
                switch (command)
                {
                    ...
                    case "adv":
                    case "advertise":
                        //p_AchievementList.IncreaseShamelessPlug();
        ...
        public bool ProcessLocalCommand(string msg, bool chat)
        {
                ...
                switch (command)
                {
                    ...
                    case "play":
                        ...
                        else
                        {
                            ...
                            Global.Steam.SendMessage(Global.FormatNumber(p_Playlist.FilteredItems.Count) + " / " + Global.FormatNumber(p_Playlist.Items.Count) + " matches containing: {ls}" + data + "{rs} " + Global.GetPercent(p_Playlist.FilteredItems.Count, p_Playlist.Items.Count) + "%", chat);
                        }
                        break;
                    ...
                    /// <Command ID="station" Param="SearchTerm" Desc="Stream radio station containing {param}" Type="4" New="1" />
                    case "station":
                        foreach (UI.Station station in p_StationList.Items)
                        {
                            if (station.Name.ToLower().Contains(data.ToLower()))
                            {
                                Global.MediaPlayer.Stream(station);
                                return true;
                            }
                        }
                    ...
                    /// <Command ID="bulgarian" Param="Text" Desc="Translate english to {id}" Type="3" New="1" />
                    case "bulgarian":
                        Global.Steam.SendMessage(Global.TranslateText(data, "en", "bg", "Bulgarian"), chat);
                        break;

                    /// <Command ID="catalan" Param="Text" Desc="Translate english to {id}" Type="3" New="1" />
                    case "catalan":
                        Global.Steam.SendMessage(Global.TranslateText(data, "en", "ca", "Catalan"), chat);
                        break;

                    /// <Command ID="chinese" Param="Text" Desc="Translate english to {id}" Type="3" New="1" />
                    case "chinese":
                        Global.Steam.SendMessage(Global.TranslateText(data, "en", "zh-CHS", "Chinese"), chat);
                        break;

                    /// <Command ID="czech" Param="Text" Desc="Translate english to {id}" Type="3" New="1" />
                    case "czech":
                        Global.Steam.SendMessage(Global.TranslateText(data, "en", "cs", "Czech"), chat);
                        break;

                    /// <Command ID="danish" Param="Text" Desc="Translate english to {id}" Type="3" New="1" />
                    case "danish":
                        Global.Steam.SendMessage(Global.TranslateText(data, "en", "da", "Danish"), chat);
                        break;

                    /// <Command ID="dutch" Param="Text" Desc="Translate english to {id}" Type="3" New="1" />
                    case "dutch":
                        Global.Steam.SendMessage(Global.TranslateText(data, "en", "nl", "Dutch"), chat);
                        break;

                    /// <Command ID="estonian" Param="Text" Desc="Translate english to {id}" Type="3" New="1" />
                    case "estonian":
                        Global.Steam.SendMessage(Global.TranslateText(data, "en", "et", "Estonian"), chat);
                        break;

                    /// <Command ID="finnish" Param="Text" Desc="Translate english to {id}" Type="3" New="1" />
                    case "finnish":
                    ...
                    /// <Command ID="german" Param="Text" Desc="Translate english to {id}" Type="3" New="1" />
                    case "german":
                        Global.Steam.SendMessage(Global.TranslateText(data, "en", "de", "German"), chat);
                        break;

                    /// <Command ID="greek" Param="Text" Desc="Translate english to {id}" Type="3" New="1" />
                    case "greek":
                        Global.Steam.SendMessage(Global.TranslateText(data, "en", "el", "Greek"), chat);
                        break;

                    /// <Command ID="haitian" Param="Text" Desc="Translate english to {id}" Type="3" New="1" />
                    case "haitian":
                    ...
                    /// <Command ID="hindi" Param="Text" Desc="Translate english to {id}" Type="3" New="1" />
                    case "hindi":
                    ...
                    /// <Command ID="indonesian" Param="Text" Desc="Translate english to {id}" Type="3" New="1" />
                    case "indonesian":
                    ...
                    /// <Command ID="korean" Param="Text" Desc="Translate english to {id}" Type="3" New="1" />
                    case "korean":
                        Global.Steam.SendMessage(Global.TranslateText(data, "en", "ko", "Korean"), chat);
                        break;

                    /// <Command ID="latvian" Param="Text" Desc="Translate english to {id}" Type="3" New="1" />
                    case "latvian":
                        Global.Steam.SendMessage(Global.TranslateText(data, "en", "lv", "Latvian"), chat);
                        break;

                    /// <Command ID="lithuanian" Param="Text" Desc="Translate english to {id}" Type="3" New="1" />
                    case "lithuanian":
                        Global.Steam.SendMessage(Global.TranslateText(data, "en", "lt", "Lithuanian"), chat);
                        break;

                    /// <Command ID="norwegian" Param="Text" Desc="Translate english to {id}" Type="3" New="1" />
                    case "norwegian":
                        Global.Steam.SendMessage(Global.TranslateText(data, "en", "no", "Norwegian"), chat);
                        break;

                    /// <Command ID="polish" Param="Text" Desc="Translate english to {id}" Type="3" New="1" />
                    case "polish":
                    ...
                    /// <Command ID="romanian" Param="Text" Desc="Translate english to {id}" Type="3" New="1" />
                    case "romanian":
                    ...
                    /// <Command ID="slovakian" Param="Text" Desc="Translate english to {id}" Type="3" New="1" />
                    case "slovakian":
                        Global.Steam.SendMessage(Global.TranslateText(data, "en", "sk", "Slovakian"), chat);
                        break;

                    /// <Command ID="slovenian" Param="Text" Desc="Translate english to {id}" Type="3" New="1" />
                    case "slovenian":
                    ...
                    /// <Command ID="swedish" Param="Text" Desc="Translate english to {id}" Type="3" New="1" />
                    case "swedish":
                        Global.Steam.SendMessage(Global.TranslateText(data, "en", "sv", "Swedish"), chat);
                        break;

                    /// <Command ID="thai" Param="Text" Desc="Translate english to {id}" Type="3" New="1" />
                    case "thai":
                        Global.Steam.SendMessage(Global.TranslateText(data, "en", "th", "Thai"), chat);
                        break;

                    /// <Command ID="turkish" Param="Text" Desc="Translate english to {id}" Type="3" New="1" />
                    case "turkish":
                        Global.Steam.SendMessage(Global.TranslateText(data, "en", "tr", "Turkish"), chat);
                        break;

                    /// <Command ID="ukrainian" Param="Text" Desc="Translate english to {id}" Type="3" New="1" />
                    case "ukrainian":
                    ...
                    /// <Command ID="joingame" Param="FriendName" Desc="Join current game for {param}" Type="2" New="1" />
                    case "joingame":
                        foreach (SteamAPI.SteamID id in Global.Steam.Client.GetFriends())
                        {
                            if (Global.Steam.Client.GetFriendPersonaName(id).ToLower().Contains(data.ToLower()))
                    ...
                    case "profile":
                        foreach (SteamAPI.SteamID id in Global.Steam.Client.GetFriends())
                        {
                            if (Global.Steam.Client.GetFriendPersonaName(id).ToLower().Contains(data.ToLower()))
                            {
                                Global.Steam.SendStatus("Viewing STEAMp3 profile for", Global.Steam.Client.GetFriendPersonaName(id), chat);
                                Process.Start("http://steamp3.ta0soft.com/profile.php?id=" + Global.GetCommunityID(id));
                                return true;
                            }
                        }
                    ...
                    /// <Command ID="stats" Param="FriendName" Desc="Scroll STEAMp3 stats for {param}" Type="3" New="1" />
                    case "stats":
                        foreach (SteamAPI.SteamID id in Global.Steam.Client.GetFriends())
                        {
                            if (Global.Steam.Client.GetFriendPersonaName(id).ToLower().Contains(data.ToLower()))
            ...
            else
            {
                switch (command)
                {
                    /// <Command ID="cq/clear" Param="" Desc="Clear playlist search queue" Type="1" New="1" />
                    case "cq":
                    case "clear":
                        p_Playlist.FilterBar.TextBox.Text = string.Empty;
                        Global.Steam.SendStatus("Playlist search queue", "Cleared", chat);
                        break;
                    ...
                    /// <Command ID="radio" Param="" Desc="View Radio tab" Type="4" New="1" />
                    case "radio":
                        p_TabContainer.SelectedIndex = 1;
                    ...
                    case "favorites":
                        ...
                        Global.Steam.SendStatus("Viewing", "Favorites", chat);
                        Global.SetForegroundWindow(Handle);
                        break;
                    ...
                    case "recent":
                        ...
                        Global.Steam.SendStatus("Viewing", "Recently Played", chat);
                        Global.SetForegroundWindow(Handle);
                        break;
                    ...
                    /// <Command ID="song" Param="" Desc="Scroll current song name" Type="1" New="1" />
                    case "song":
                    ...
                    /*
                    <Command ID="rf/rfav" Param="" Desc="Play random favorite" Type="1" New="0" />
                    case "rf":
                    case "rfav":
                        list = new List<UI.PlaylistItem>();
                    ...
                    */
                    ...
                    /// <Command ID="rt/runtime" Param="" Desc="Scroll STEAMp3 run-time" Type="4" New="1" />
                    case "rt":
                    case "runtime":
                    ...
                    case "cp":
                    case "controlpanel":
                        Global.Steam.SendStatus("Launching", "Windows control panel", chat);
                    ...
                    /// <Command ID="battery/power" Param="" Desc="Scroll current battery life" Type="4" New="0" />
                    case "battery":
                    case "power":
                    ...
                    /// <Command ID="stats" Param="" Desc="Scroll current STEAMp3 stats" Type="3" New="1" />
                    case "stats":
                        ts = DateTime.Now.Subtract(Process.GetCurrentProcess().StartTime);
                    ...
                    case "profile":
                        Global.Steam.SendStatus("Viewing STEAMp3 profile for", Global.Steam.Client.GetPersonaName(), chat);
                        Process.Start("http://steamp3.ta0soft.com/profile.php?id=" + Global.GetCommunityID(Global.Steam.Client.GetSteamID()));
                        break;
    ...
    public class MediaPlayer
    {
        ...
        public int Position
        {
            get { return Convert.ToInt32(p_WMP.controls.currentPosition); }
            set
            {
        ...
        public int Duration
        {
            get { return Convert.ToInt32(p_WMP.currentMedia.duration); }
        }

        public bool IsOnline
        {
            get { return p_WMP.isOnline; }
        }

        public int Volume
        {
            get { return p_WMP.settings.volume; }
            set
            {
            ...
            else //if (p_WMP.playState == WMPPlayState.wmppsStopped || p_WMP.playState == WMPPlayState.wmppsReady)
            {
                ...
                switch (p_PlayMode)
                {
                    ...
                    case PlayModes.Repeat:
                        Play(Global.MainWindow.Playlist.PlayingItem, "Repeat", true);
                        break;
                }
            }
        }
        ...
        private void p_Shoutcast_TitleReceived(object sender, string title)
        {
            ...
            if (string.IsNullOrEmpty(p_StreamTitle) || !p_StreamTitle.Equals(title))
            {
                ...
                UI.PlaylistItem item = new UI.PlaylistItem(Global.MainWindow.StationList.PlayingItem.StreamURL, art, tit, Global.MainWindow.StationList.PlayingItem.Genre, Global.MediaPlayer.WMP.network.bitRate / 1000);

                item.Update();

                Global.MainWindow.Playlist.PlayingItem = item;

                Global.Steam.SendMessage("Streaming: {ls}" + item.Text + "{rs}", true);
            }
        }
        #endregion
        ...
        public bool Stream(UI.Station station)
        {
            Stop(string.Empty, true);
            //Pause(string.Empty, true);
            Global.MainWindow.SeekBar.Maximum = 0; //?
            ...
            //if (!string.IsNullOrEmpty(status)) Global.Steam.SendMessage(status + ": {ls}" + station.Name + "{rs} Genre: {ls}" + station.Genre + "{rs}", chat);
        ...
        {
            if (p_Devices.Count == 0) return null;
    ...
    public class Settings
    {
        ...
        public bool Load(string url)
        {
            ...
            try
            {
                ...
                p_MusicFilter = Global.GetXmlValue(node.SelectSingleNode("Music"), "Filter", ".mp3;.m4a;.wav;.wma");
        ...
        public bool Save()
        {
            try
            {
                ...
                XmlWriter writer = XmlWriter.Create(p_URL, settings);

                //Global.SaveString(xml.OuterXml, Application.StartupPath + "\\settings.txt");
                xml.Save(writer);
        ...
        private void LoadRadioStations(XmlNode node)
        {
            ...
            {
                p_RadioStations.Add(new UI.Station(Global.GetXmlValue(node2, "URL", "N/A"), Global.GetXmlValue(node2, "Name", "N/A"), Global.GetXmlValue(node2, "Genre", "N/A")));
            }
        }
        #endregion
    }
    ...
    {
        #region Objects
        private int p_CommandsUsed;
        private int p_LastOnline;
        private int p_Loads;
        private bool p_Online;
        private int p_PlayTime;
        private int p_RunTime;
        private string p_Skin;
        private int p_SongsCompleted;
        private int p_SongsPlayed;
        private int p_UserSince;

        private int p_ChattyCathy;
        private int p_JukeboxHero;
        private int p_LeetHaxor;
        private int p_MP3Playah;
        private int p_Repetition;
        ...
        public Stats()
        {
            ...
            try
            {
                ...
                string data = "login=" + Global.Steam.Client.GetSteamID().ToUInt64().ToString() + "&build=" + Application.ProductVersion;
        ...
        public void Dispose()
        {
            try
            {
                ...
                string data = "logout=" + Global.Steam.Client.GetSteamID().ToUInt64().ToString() + "&commandsUsed=" + p_CommandsUsed.ToString() + "&playTime=" + p_PlayTime.ToString() + "&runTime=" + p_RunTime.ToString() + "&skin=" + HttpUtility.UrlEncode(p_Skin) + "&songsCompleted=" + p_SongsCompleted.ToString() + "&songsPlayed=" + p_SongsPlayed.ToString();
                // data += "&chattyCathy=" + p_ChattyCathy.ToString() + "&jukebox=" + p_Jukebox.ToString() + "&leetHaxor=" + p_LeetHaxor.ToString() + "&mp3Playah=" + p_MP3Playah.ToString() + "&repetition=" + p_Repetition.ToString();
